...
<body <?php body_class(); ?>
    ...
    data-header-resize="<?php if ( !empty( $options[ 'header-resize-on-scroll' ] ) ) {
        echo $options[ 'header-resize-on-scroll' ];
    } else {
        echo '0';
    } ?>"
                ...
                <?php if ( !empty( $options[ 'enable_social_in_header' ] ) && $options[ 'enable_social_in_header' ] == '1' ) { ?>
                    <ul id="social">
                        ...
                        <?php if ( !empty( $options[ 'use-behance-icon-header' ] ) && $options[ 'use-behance-icon-header' ] == 1 ) { ?>
                            <li><a target="_blank" href="<?php echo $options[ 'behance-url' ]; ?>"><i
                                        class="icon-be"></i> </a></li> <?php } ?>
...
<div id="header-outer" <?php echo $transparency_markup; ?>
     ...
     data-header-resize="<?php if ( !empty( $options[ 'header-resize-on-scroll' ] ) ) echo $options[ 'header-resize-on-scroll' ]; ?>">
                        ...
                        <div class="pull-right m-l-20 user-actions">
                            ...
                            <ul id="menu1" class="menu nav quick-section ">
                                <li class="quicklinks btn">
                                    ...
                                    <ul id="popup" class="dropdown-menu  pull-right" role="menu"
                                        aria-labelledby="user-options">
                                        <li id="logout">
                                            <a href="#logout"> <i class="fa fa-power-off"></i>&nbsp;&nbsp;Log
                                                Out </a>
                                        </li>
                                    </ul>
                                </li>
        ...
        if ( $woocommerce ) {
            ...
            <div class="cart-outer">
                <div class="cart-menu-wrap">
                    <div class="cart-menu">
                        <a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>">
                            <div class="cart-icon-wrap"><i class="icon-shopping-cart"></i>
                ...
                <div class="cart-notification">
                    <span
                        class="item-name"></span> <?php echo __( 'was successfully added to your cart.', NECTAR_THEME_NAME ); ?>
                </div>
