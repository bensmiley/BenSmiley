...
function nectar_slider_order_page() {
    ...
    <div class="wrap"
        ...
        <p>Choose your slider location below and simply drag your slides up or down - they will automatically be saved
            in that order.</p>
...
if ( !function_exists( 'nectar_slider_display' ) ) {
    ...
    function nectar_slider_display( $config_arr ) {
        ...
        if ( $slides->have_posts() ) :  while ( $slides->have_posts() ) : $slides->the_post();
            ...
            if ( $background_type == 'image_bg' ) {
                $bg_img_markup = 'style="background-image: url(' . $slide_image . ');"';
            } else {
                $bg_img_markup = null;
            }
    ...
    function nectar_page_header( $postid ) {
        ...
        if ( !empty( $bg ) || !empty( $bg_color ) ) {
            ...
            if ( !empty( $parallax_bg ) && $parallax_bg == 'on' ) {
                echo '<div id="page-header-wrap">';
            } ?>
            <div class="not-loaded" id="page-header-bg"
                 ...
                 style="background-color: <?php echo $bg_color ?>; background-image: <?php echo $bg; ?>; height: <?php echo $height; ?>px;">
                                ...
                                <div
                                    ...
                                    if ( !empty( $page_link ) && $back_to_all_override == 'default' ) {
                                        ...
                                        <div id="portfolio-nav">
                                            <ul>
                                                <li id="all-items"><a href="<?php echo $portfolio_link; ?>"><i
                                ...
                                <div id="single-meta"
                                    ...
                                    <?php if ( !empty( $options[ 'blog_social' ] ) && $options[ 'blog_social' ] == 1 ) {
                                        ...
                                        if ( !empty( $options[ 'blog-google-plus-sharing' ] ) && $options[ 'blog-google-plus-sharing' ] == 1 ) {
                                            echo "<a class='google-plus-share nectar-sharing-alt' href='#' title='" . __( 'Share this', NECTAR_THEME_NAME ) . "'> <i class='icon-google-plus'></i> <span class='count'> " . GetGooglePlusShares( get_the_permalink() ) . " </span></a>";
                                        }
                        ...
                        <div class="row">
                            ...
                            if ( $page_template == 'template-portfolio.php' && $display_sortable == '1' && $inline_filters == '0' ) {
                                ...
                                <div id="<?php echo $filters_id; ?>">
                                    ...
                                    <ul>
                                        <li><a href="#"
                                               data-filter="*"><?php echo __( 'All', NECTAR_THEME_NAME ); ?></a></li>
            ...
            <?php if ( !empty( $parallax_bg ) && $parallax_bg == 'on' ) {
                echo '</div>';
            } ?>
...
function using_page_header( $post_id ) {
    ...
    if ( is_search() || is_tax() || $disable_effect == 'on' ) {
        $using_applicable_shortcode = 0;
        $header_bg = 0;
        $header_bg_color = 0;
    }
