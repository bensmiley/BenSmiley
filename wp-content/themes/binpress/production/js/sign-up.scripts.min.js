...
define("../js/bower_components/almond/almond.js", function(){});
...
define('modules/signup',['jquery', 'jquery-validate'], function() {
...
// Generated by CoffeeScript 1.7.1
define('modules/login',['jquery', 'jquery-validate', 'bootstrap'], function() {
  return $(document).ready(function() {
    var formatLoginData;
    jQuery.validator.setDefaults({
      debug: true,
...
;
// Generated by CoffeeScript 1.7.1
define('modules/forgot-password',['jquery', 'jquery-validate'], function() {
  return $(document).ready(function() {
...
;
define("../js/sign-up.scripts.js", function(){});
