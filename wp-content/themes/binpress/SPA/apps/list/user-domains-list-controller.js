    ...
    return App.module("UserDomainApp.List", function(List, App, BackBone, Marionette, $, _) {
      ...
      UserDomainListController = (function(_super) {
        ...
        function UserDomainListController() {
          this.domainDeleted = __bind(this.domainDeleted, this);
        ...
        UserDomainListController.prototype.domainDeleted = function() {
          return this.domainListView.triggerMethod("domain:deleted");
        };
