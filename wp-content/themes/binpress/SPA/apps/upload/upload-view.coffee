define [ 'app', 'plupload' ], (App, plupload)->
        ...
        class View.UploadView extends Marionette.ItemView
            ...
            template : '<div class="col-md-3 text-center">
                            <div class="profile-wrapper pull-right">
                                ...
                                <a id="add-photo" class="m-t-10" href="#" data-color-format="hex">
                                    Click to add/edit Profile Photo
                                </a>
                            </div>
                        </div>
                       ...
                       <div>
                       <input type="hidden" name="image_id"/></div>'
            ...
            onShow : ->
                ...
                @uploader.bind "FileUploaded", (up, file, response)=>
                    ...
                    if response.success
                        @$el.find('input[name="image_id"]').val(response.data.id)
