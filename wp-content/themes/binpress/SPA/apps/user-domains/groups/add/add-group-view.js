...
define(['marionette'], function(Marionette) {
  ...
  AddGroupView = (function(_super) {
    ...
    AddGroupView.prototype.template = ' <div class="row"> <div class="col-md-3"> <img src="../wp-content/themes/binpress/images/default.png" class=" image-responsive-width"/> <br><br> <button type="submit" class="btn btn-primary btn-block"><i class="icon-ok"></i> Edit Group Image</button> </div> <div class="col-md-9"> <div class="form-group"> <label class="form-label">Group Name</label> <span class="help">e.g. "xyz"</span> <div class="input-with-icon  right"> <i class=""></i> <input type="text" name="group_name" id="group_name" class="form-control"> </div> </div> <div class="form-group"> <label class="form-label">Description</label> <div class="input-with-icon  right"> <i class=""></i> <textarea type="text" name="group_description" id="group_description" class="form-control"> </textarea> </div> </div> <div class="pull-right"> <button type="button" class="btn btn-success btn-cons" id="btn-save-domain-group"> <i class="icon-ok"></i> Save</button> <input type="reset" style="display: none" id="btn-reset-group"/> </div> </div> </div>';
