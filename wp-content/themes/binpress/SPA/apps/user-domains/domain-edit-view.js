(function() {
  ...
  define(['marionette', 'text!apps/user-domains/templates/AddEditUserDomain.html'], function(Marionette, addEditUserDomainTpl) {
    ...
    ActiveSubscriptionView = (function(_super) {
      ...
      ActiveSubscriptionView.prototype.template = '<div class="alert alert-info"><h3 class="m-b-20"><span class="semi-bold">Plans Details</span></h3> <div class="grid simple"> <dl class="dl-horizontal dl-plan"> <dt>Current Plan :</dt> <dd><span class="label label-info">{{plan_name}}</span></dd> <dt>Billing Amount :</dt> <dd>{{price}}/month</dd> <dt>Billing Cycle :</dt> <dd>{{bill_start}} To {{bill_end}}</dd> </dl> <div class="clearfix"></div> <br> <div class="text-muted">Avail more features by upgrading your plan. Click change plan to view the available plans</div> </div></div> <div class="alert alert-info"><h3 class="m-b-20"><span class="semi-bold">Future Plan Details</span></h3> <div class="grid simple"> <dl class="dl-horizontal dl-plan"> <dt>Future Details:</dt> <dd><span class="label label-info">{{plan_name}}</span></dd> <dt>Billing Amount :</dt> <dd>{{price}}/month</dd> <dt>Billing Cycle :</dt> <dd>{{bill_start}} To {{bill_end}}</dd> </dl> <a href="#domains/edit/{{domain_id}}/list-plan" class="btn btn-success btn-block"> <i class="icon-ok"></i> Change Plan</a> <div class="clearfix"></div> <br> <div class="text-muted">Avail more features by upgrading your plan. Click change plan to view the available plans</div> </div></div>';
