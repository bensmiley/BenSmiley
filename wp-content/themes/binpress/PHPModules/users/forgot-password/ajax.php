...
function ajax_reset_user_password() {
    ...
    **/
    ...
    /**EMAILS THROUGH COMM MODULE**/
    $userdata = array('user_name' => $user_data->display_name, 
                      'user_email' => $user_data->user_email );
    user_password_reset_email($userdata,$hashed_user_activation_key);
